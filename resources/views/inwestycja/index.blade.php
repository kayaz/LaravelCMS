...
@section('content')
                ...
                <table class="table mb-0" id="sortable">
                    ...
                    @foreach ($lista as $index => $p)
                        <tr id="recordsArray_{{ $p->id }}">
                            ...
                            <td class="option-120">
                                <div class="btn-group">
                                    <a href="#" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Plan inwestycji"><i class="fe-image"></i></a>
                                    <a href="#" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Pokaż inwestycję"><i class="fe-layers"></i></a>
                                    <a href="{{route('admin.inwestycja.edytuj', ['id' => $p->id])}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj wpis"><i class="fe-edit"></i></a>
                                    <form method="POST" action="{{route('admin.inwestycja.usun', ['id' => $p->id])}}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
    ...
    <div class="form-group form-group-submit row">
        <div class="col-12">
            <a href="{{route('admin.inwestycja.dodaj')}}" class="btn btn-primary">Dodaj inwestycje</a>
        </div>
    </div>
@endsection
