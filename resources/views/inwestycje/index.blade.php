...
@section('content')
                        ...
                        <tr id="recordsArray_{{ $p->id }}">
                            ...
                            <td class="option-120">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('admin.inwestycje.edytuj', ['id' => $p->id])}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj wpis"><i class="fe-edit"></i></a>
    ...
    <div class="form-group form-group-submit row">
        <div class="col-12">
            <a href="{{route('admin.inwestycje.dodaj')}}" class="btn btn-primary">Dodaj inwestycje</a>
        </div>
    </div>
@endsection
