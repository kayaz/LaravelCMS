...
namespace App\Http\Controllers\AdminUstawienia;
...
class IndexController extends Controller
{
    ...
    public function update(StoreAdmin $request, Settings $settings)
    {
        ...
        return redirect('admin/ustawienia/')->with('success', 'Ustawienia zostały zaktualizowane');
    }
    ...
    public function socialupdate(Request $request, Settings $settings)
    {
        ...
        return redirect('admin/ustawienia/social/')->with('success', 'Ustawienia zostały zaktualizowane');
    }
}
