    ...
    <div id="kontakt" class="container pt-5">
        <div class="row">
            ...
            <div class="col-5 col-overmap">
                ...
                @endif
                <form method="post" action="{{ route('front.contact.send') }}" class="">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12 col-input">
                            <label for="form_name">Imię lub nazwa firmy</label>
                            <input name="name" id="form_name" class="validate[required]" type="text">
                        </div>
                        ...
                        <div class="col-6 col-input mt-2">
                            ...
                            <input name="phone" id="form_phone" class="validate[required]" type="text">
                        </div>
                        <div class="col-12 mt-2">
                            <label for="form_message">Treść wiadomości</label>
                            <textarea rows="1" cols="1" name="message" id="form_message"></textarea>
                        </div>
