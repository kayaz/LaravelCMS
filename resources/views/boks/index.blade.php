...
@section('content')
                        ...
                        <tr id="recordsArray_{{ $p->id }}">
                            ...
                            <td class="option-120">
                                <div class="btn-group">
                                    ...
                                    <a href="{{route('admin.boks.edytuj', ['id' => $p->id])}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj wpis"><i class="fe-edit"></i></a>
                                    <form method="POST" action="{{route('admin.boks.usun', ['id' => $p->id])}}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
    ...
    <div class="form-group form-group-submit row">
        <div class="col-12">
            <a href="{{route('admin.boks.dodaj')}}" class="btn btn-primary">Dodaj boks</a>
        </div>
    </div>
    <script type="text/javascript" language="javascript">
        //<![CDATA[
        $(document).ready(function(){
            $("#sortable tbody.content").sortuj('{{route('admin.boks.sort')}}');
        });
        //]]>
    </script>
@endsection
