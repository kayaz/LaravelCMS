<div class="card-header border-bottom">
    <nav class="nav">
        <a class="nav-link {{ Request::routeIs('admin.investments.edytuj') ? ' active' : '' }}" href="{{route('admin.investments.edytuj', ['investment' => $investment->id])}}"><span class="fe-info"></span> {{$investment->nazwa}}</a>
        @if ($investment->typ == 2)
