<div class="card-header border-bottom">
    <nav class="nav">
        <a class="nav-link {{ Request::routeIs('admin.ustawienia.index') ? ' active' : '' }}" href="{{route('admin.ustawienia.index')}}"><span class="fe-settings"></span> Główne ustawienia strony</a>
