                ...
                <table class="table mb-0" id="sortable">
                    ...
                    @foreach ($list as $index => $p)
                        <tr id="recordsArray_{{ $p->id }}">
                            ...
                            <td class="option-120">
                                <div class="btn-group">
                                    <a href="{{route('admin.users.haslo', $p->id)}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj hasło"><i class="fe-shield"></i></a>
                                    <a href="{{route('admin.users.edytuj', $p->id)}}" class="btn action-button mr-1" data-toggle="tooltip" data-placement="top" title="Edytuj użytkownika"><i class="fe-edit"></i></a>
                                    <form method="POST" action="{{route('admin.users.usun', $p->id)}}">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
