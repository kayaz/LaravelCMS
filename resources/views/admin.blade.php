...
<div id="admin">
    ...
    <div id="content">
        <header id="header-navbar">
            <h1><a href="" class="logo"><span>kCMS v4.1 (Laravel)</span></a></h1>
            ...
            <div class="user">
                <ul class="none">
                    ...
                    <li><a title="Idź do strony" href="{{route('front.index')}}" target="_blank"><span class="fe-monitor"></span> Idź do strony</a></li>
                    <li>
